        ...
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                    <ProfileAvatar firstName={firstName} className="size-32.5 shrink-0" />
                    <div>
                        <p className="text-sm font-semibold text-slate-900">Your profile</p>
                        <p className="mt-1 text-sm text-slate-500">This placeholder avatar keeps your profile recognizable until you add a photo.</p>
                    </div>
                </div>
